  ...
  <div class="col-md-7 align-self-center card-body">
      <form action="{{ url('student') }}" method="post">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-7">
            <input type="number" name="STUDENT_LRN" id="STUDENT_LRN" class="form-control" required> 
          </div>
        </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-7">
            <select name="YEAR_LEVEL" id="YEAR_LEVEL" class="form-control" required>
              <option name="YEAR_LEVEL" value="First Year" disabled selected>Select Year Level</option>
